...
static void
api_start_activity (context_t * C)
{
  if (C->containment == 0)
    {
      fprintf (C->out,
...
static void
api_string (context_t * C, elem_t * branch)
{
  fprintf (C->out, "\t\"");
...
static void
api_token (context_t * C, char token)
{
...
static void
api1_act (context_t * C, elem_t * tree)
{
