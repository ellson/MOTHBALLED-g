...
<NODES NODENOUN><= NODENOUN>[OPT SREP]
<EDGES EDGENOUN<= EDGENOUN>[OPT REP]
...
<NODE NODEID>
<EDGE LAN><= LEG>[OPT SREP]<= RAN>
<LEG SAMEAS>[ALT]<= ENDPOINTSET>[ALT]<= ENDPOINT>
<ENDPOINTSET LPN><= ENDPOINT><= ENDPOINT>[OPT SREP]<= RPN>
<ENDPOINT PORT>[ALT]<= FAMILY>[ALT]<= RELATIVE>[ALT]<= SAMEAS>
<SAMEAS EQL>
<FAMILY SIS><= KID>[OPT REP]
<RELATIVE MUM><= MUM>[OPT REP]<= SIS><= KID>[OPT REP]
<SIS NODEREF><= PORT>[OPT]
<MUM HAT>
<KID FSL><= NODEREF><= PORT>[OPT]
<NODEREF NODEID>
<PORT CLN><= PORTID>
