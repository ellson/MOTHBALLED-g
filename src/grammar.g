<ACTIVITY ACT>[SREP]
<ACT VERB>[OPT]<= SUBJECT><= ATTRIBUTES>[OPT]<= CONTENTS>[OPT]<= TERM>[OPT]
<VERB TLD>[ALT]<= QRY>
<SUBJECT NOUN>[ALT]<= NOUNSET>
<NOUN EDGE>[ALT]<= NODE>
<NOUNSET LPN><= NOUNLIST><= RPN>
<NOUNLIST NODELIST>[ALT]<= EDGELIST>
<NODELIST NODE>[REP]
<EDGELIST EDGE>[REP]
...
<LEG EQL>[ALT]<= ENDPOINTSET>[ALT]<= ENDPOINT>
<ENDPOINTSET LPN><= ENDPOINT>[SREP]<= RPN>
<ENDPOINT PORT>[ALT]<= FAMILY>[ALT]<= RELATIVE>[ALT]<= EQL>
