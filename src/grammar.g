<ACTIVITY ACT><= ACT>[SREP]
<ACT ACTION>[OPT]<= SUBJECT><= ATTRIBUTES>[OPT]<= CONTAINER>[OPT]<= TERM>[OPT]
<ACTION TLD>
<SUBJECT OBJECT>[ALT]<= OBJECT_LIST>[ALT]
<ATTRIBUTES LBR><= ATTR>[OPT]<= ATTR>[OPT SREP]<= RBR>
<CONTAINER LBE><= ATTRIBUTES>[OPT]<= ACT>[OPT]<= ACT>[OPT SREP]<= RBE>
<TERM SCN>
<OBJECT_LIST LPN><= OBJECT><= OBJECT>[SREP]<= RPN>
