...
<NODES NODENOUN><= NODENOUN>[REQWS REP]
<EDGES EDGENOUN<= EDGENOUN>[REP]
<ATTRIBUTES LBR><= ATTR>[REQWS REP]<= RBR>
<CONTENTS LBE><= ACTIVITY>[OPT]<= RBE>
<TERMINAL SCN>
<NODENOUN NODE>[ALT]<= PORT>[ALT]<= SAMEAS>
<EDGENOUN EDGE>[ALT]<= SAMEAS>
<NODE NODEID>
<EDGE LAN><= LEG>[REQWS REP]<= RAN>
<LEG SAMEAS>[ALT]<= ENDPOINTSET>[ALT]<= ENDPOINT>
<ENDPOINTSET LPN><= ENDPOINT><= ENDPOINT>[REQWS REP]<= RPN>
<ENDPOINT PORT>[ALT]<= FAMILY>[ALT]<= RELATIVE>[ALT]<= SAMEAS>
<SAMEAS EQL>
<FAMILY SIS><= KID>[REQNOWS REP]
<RELATIVE MUM><= MUM>[REQNOWS REP]<= SIS>[REQNOWS]<= KID>[REQNOWS REP]
<SIS NODEREF><= PORT>[REQNOWS OPT]
<MUM HAT>
<KID FSL>[REQNOWS]<= NODEREF>[REQNOWS]<= PORT>[REQNOWS OPT]
<NODEREF NODEID>
<PORT CLN>[REQNOWS]<= PORTID>
<DISAMBIG TIC>[REQNOWS]<= DISAMBID>[REQNOWS]
